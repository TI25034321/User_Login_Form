 ...
 */
package com.mycompany.user_login_form;
...
public class Login_Form extends javax.swing.JFrame {
    ...
    if (jRadioButton1.isSelected()){
       role = "Admin";
        ...
        jLabel4.setText("Please select role.");
        return;
    }
    jLabel4.setText("The usename is " +username+ "and password is " +password+ "and your role is " +role+ ".");
